...
public class GlobalThreadPool {
	 ...
	 * @return
	 */
	public static Map<String,Integer> getCurrentThreadPoolStatus(){
		Map<String,Integer> status = new HashMap<String,Integer>();
		status.put("globalCoreSize", globalThreadPool.getCorePoolSize());
		status.put("globalMaxSize", globalThreadPool.getMaximumPoolSize());
		status.put("globalActiveSize", globalThreadPool.getActiveCount());
		status.put("globalQueueSize", globalThreadPool.getQueue().size());
		return status;
	}
